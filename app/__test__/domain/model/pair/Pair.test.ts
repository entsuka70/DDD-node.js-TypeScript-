...
describe('domain/model/pair Pair', () => {
    describe('正常系テスト', () => {
        ...
        const userIdMock = jest.fn().mockReturnValueOnce('168fc428-6761-404c-952f-d56c3d39d6b0').mockReturnValueOnce('268fc428-6761-404c-952f-d56c3d39d6b0').mockReturnValueOnce('368fc428-6761-404c-952f-d56c3d39d6b0');
        const otherUserIdMock = jest.fn().mockReturnValueOnce('468fc428-6761-404c-952f-d56c3d39d6b0').mockReturnValueOnce('568fc428-6761-404c-952f-d56c3d39d6b0').mockReturnValueOnce('668fc428-6761-404c-952f-d56c3d39d6b0');
        ...
        it('Pairインスタンスメソッドが意図した通りに動作する', () => {
            ...
            expect(pair.isExistUser('168fc428-6761-404c-952f-d56c3d39d6b0')).toBeFalsy();
        });

        it('Pairインスタンスメソッドが意図したとおりに動作する', () => {
            pair.changeUserIds(other_user_ids);
            expect(pair.getUserIds()).toHaveLength(3);
            expect(pair.isExistUser('468fc428-6761-404c-952f-d56c3d39d6b0')).toBeTruthy();
        });
    });
    describe('異常系テスト', () => {
        // 利用するPair初期化
